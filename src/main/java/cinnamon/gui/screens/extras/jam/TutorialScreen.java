...
public class TutorialScreen extends ParentedScreen {

    private static final Resource TEXTURE = new Resource("textures/jam/tutorial.png");

    public TutorialScreen(Screen parentScreen) {
        super(parentScreen);
    }
