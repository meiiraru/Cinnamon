...
import cinnamon.world.worldgen.chunk.ArrayChunk;
...
public class TerrainGenerator {
    ...
    public static Chunk emptyChunk(int x, int y, int z) {
        return new ArrayChunk(x, y, z);
    }

    public static Chunk generatePlain(int x, int y, int z) {
        Chunk chunk = emptyChunk(x, y, z);
